    ...
    <div class="container">
        ...
        <main class="main-content">
            <section class="section">
                <h2>Recent Favorites
                    <a href="favorites.html" class="view-more">View All →</a>
                </h2>
            ...
            <section class="section">
                <h2>Recent Reviews
                    <a href="reviews.html" class="view-more">View All →</a>
                </h2>
                <div class="films-container">
            ...
            <section class="section">
                <h2>Watch List
                    <a href="watchlist.html" class="view-more">View All →</a>
                </h2>
                <div class="films-container">
                    <a href="shawshank.html" class="film-card">
                        <div class="film-poster">
        ...
        <aside class="sidebar">
            ...
            <ul>
                <li><a href="userprofile-edit.jsp">Edit Profile</a></li>
                <li><a href="userprofile-favorites.jsp">Favorites</a></li>
                <li><a href="userprofile-ratings.jsp">Ratings</a></li>
                <li><a href="userprofile-review.jsp">Reviews</a></li>
                <li><a href="userprofile-watchlist.jsp">Watchlist</a></li>
                <li><a href="userprofile-logout.jsp">Logout</a></li>
            </ul>
        </aside>
    </div>
