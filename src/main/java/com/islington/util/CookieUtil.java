...
/**
 * Utility class for managing cookies in the ReelThoughts web application.
 * Provides methods to add, retrieve, and delete cookies.
 */
public class CookieUtil {

    /**
     * Adds a cookie with the specified name, value, and expiration time.
     *
    ...
    public static void addCookie(HttpServletResponse response, String name, String value, int maxAge) {
        ...
        cookie.setPath("/"); // Makes cookie available to the entire application
    ...
    /**
     * Deletes a cookie by its name by setting its max age to 0.
     *
    ...
    public static void deleteCookie(HttpServletResponse response, String name) {
        ...
        cookie.setPath("/");  // Ensure the path matches where it was set
        response.addCookie(cookie);
    }
}
